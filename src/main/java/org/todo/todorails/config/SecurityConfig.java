    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .authorizeRequests(authorize -> authorize
                         ...
                         *           "/register.js" without logging in
                         */
//                        .requestMatchers("/css/**", "/register.js").permitAll()
                        // allow access to static resources
                        .requestMatchers("/js/**", "/images/**", "/css/**").permitAll()
                        // allow access to register.js, login, terms and index without logging in
    ...
    // Generate a PasswordEncoder bean to encode passwords
    @Bean
